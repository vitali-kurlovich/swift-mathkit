...
public extension MKPoint where Float == Double {
...
public extension MKPoint where Float == CGFloat {
    @inlinable func applying(_ t: MKAffineTransformComponents<Float>) -> Self {
        t.transform(self)
    }
...
public extension MKPoint where Float == Swift.Float {
    @inlinable func applying(_ t: MKAffineTransformComponents<Float>) -> Self {
        t.transform(self)
    }
...
public extension MKPoint where Float == Float16 {
    @inlinable func applying(_ t: MKAffineTransformComponents<Float>) -> Self {
        t.transform(self)
    }
